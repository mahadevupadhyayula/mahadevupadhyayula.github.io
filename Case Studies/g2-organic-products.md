...
<section class="workflow-cta" aria-labelledby="g2-case-study-cta">
  ...
  <a class="button-link button-primary" href="{{ '/start-a-workflow-audit/?intent=g2-implementation-onboarding-workflow' | relative_url }}">Discuss an AI Workflow Prototype</a>
</section>
