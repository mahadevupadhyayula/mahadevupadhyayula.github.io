...
<section class="workflow-cta" aria-labelledby="insight-journal-cta">
  ...
  <a class="button-link button-primary" href="{{ '/start-a-workflow-audit/?intent=insight-journal-other-internal-workflow' | relative_url }}">Discuss an AI Workflow Prototype</a>
</section>
