...
<main class="demo-shell" data-handoff-demo>
  ...
  <section class="demo-cta">
    ...
    <a class="button-link button-primary" href="{{ '/start-a-workflow-audit/?intent=implementation-intelligence' | relative_url }}" data-workflow-modal-open data-workflow-intent="implementation-intelligence">Book a Discovery Call</a>
  </section>
</main>
